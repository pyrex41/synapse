...
SQL status and resend already-settled messages. In the target system this was verified
...
do not silently reuse earlier receipts or disable hash verification. the target system
