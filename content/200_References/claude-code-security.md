...
upstream_url: https://docs.claude.com/en/docs/claude-code/security
...
-   **Command blocklist**: Blocks risky commands that fetch arbitrary content from the web like `curl` and `wget` by default. When explicitly allowed, be aware of [permission pattern limitations](https://docs.claude.com/en/docs/claude-code/iam#tool-specific-permission-rules)
...
-   **Secure credential storage**: API keys and tokens are encrypted. See [Credential Management](https://docs.claude.com/en/docs/claude-code/iam#credential-management)
...
See [here](https://docs.claude.com/en/docs/claude-code/ide-integrations#security) for more information on the security of running Claude Code in an IDE.

## Cloud execution security

When using [Claude Code on the web](https://docs.claude.com/en/docs/claude-code/claude-code-on-the-web), additional security controls are in place:
...
For more details on cloud execution, see [Claude Code on the web](https://docs.claude.com/en/docs/claude-code/claude-code-on-the-web).
...
-   Consider using [devcontainers](https://docs.claude.com/en/docs/claude-code/devcontainer) for additional isolation
-   Regularly audit your permission settings with `/permissions`

### Team security

-   Use [enterprise managed policies](https://docs.claude.com/en/docs/claude-code/iam#enterprise-managed-policy-settings) to enforce organizational standards
-   Share approved permission configurations through version control
-   Train team members on security best practices
-   Monitor Claude Code usage through [OpenTelemetry metrics](https://docs.claude.com/en/docs/claude-code/monitoring-usage)
...
-   [Sandboxing](https://docs.claude.com/en/docs/claude-code/sandboxing) - Filesystem and network isolation for bash commands
-   [Identity and Access Management](https://docs.claude.com/en/docs/claude-code/iam) - Configure permissions and access controls
-   [Monitoring usage](https://docs.claude.com/en/docs/claude-code/monitoring-usage) - Track and audit Claude Code activity
-   [Development containers](https://docs.claude.com/en/docs/claude-code/devcontainer) - Secure, isolated environments
