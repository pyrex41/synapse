...
upstream_url: https://docs.claude.com/en/docs/claude-code/slash-commands
last_synced: "2025-01-29T00:00:00.000Z"
attribution: "Anthropic"
license: "Anthropic Documentation License"
category: documentation
summary: "Control Claude's behavior during an interactive session with slash commands."
---
...
Show token usage statistics (see [cost tracking guide](https://docs.claude.com/en/docs/claude-code/costs#using-the-cost-command) for subscription-specific details)
...
View or update [permissions](https://docs.claude.com/en/docs/claude-code/iam#configuring-permissions)
...
Specific model string (see [Models overview](https://docs.claude.com/en/docs/about-claude/models/overview))
