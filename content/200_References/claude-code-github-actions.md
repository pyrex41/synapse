...
upstream_url: https://docs.claude.com/en/docs/claude-code/github-actions
...
Instructions for Claude (text or slash command)
...
Use AWS Bedrock instead of Claude API
