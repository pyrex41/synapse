...
binary as absolute host paths; `e6d2b8a` records basenames and the binary's sha256 only, which
is the evidence. The three fixture files (qualified: fact + certificate `65cffd45…9b`; unqualified:
