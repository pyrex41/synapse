...
read only). target-go pilot with `CAPCOV_GO_FIXTURE_ROOT=/Users/reuben/fg/.worktrees/target-go-capcov-claims-runtime`
...
target-go worktree at the receipt's candidate commit `01fe913`, because `/Users/reuben/fg/target-go`
