...
const modern = ["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "kernel-closure", "differential-closure", "kernel-closure-integrate", "scip-toolchain", "scip-fact-export", "static-rule-pack", "scip-datalog-differential", "datalog-certificates", "scip-target-go-pilot", "datalog-target-go", "datalog-evaluation"];
...
assert.ok(!byId.has("datalog-differential"), "the exhausted datalog-differential task is retired, not reset again");
...
assert.equal(byId.get("scip-toolchain").dependsOn[0], "kernel-closure-integrate");
...
assert.ok(byId.get("scip-target-go-pilot").mayBlock && byId.get("scip-target-go-pilot").externalPrerequisites.includes("CAPCOV_GO_FIXTURE_ROOT"));
