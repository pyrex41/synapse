...
const modern = ["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "datalog-differential", "scip-toolchain", "scip-fact-export", "static-rule-pack", "scip-datalog-differential", "datalog-certificates", "scip-target-go-pilot", "datalog-target-go", "datalog-evaluation"];
