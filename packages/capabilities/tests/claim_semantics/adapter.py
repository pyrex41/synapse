...
from capcov.claims import bundle_from_json  # noqa: E402
...
def bundle_payload(fixture: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"schema_version": 1, "relations": relations, "facts": facts, "rules": [], "claims": claims, "metadata": {"fixture_id": fixture["id"]}}
